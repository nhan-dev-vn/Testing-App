...
app.post('/api/users/:userId/update-status', ctrlAuth.checkAuth, ctrlAuth.checkAuthAdmin, ctrlUser.changeStatus);
app.get('/api/users', ctrlAuth.checkAuth, ctrlAuth.checkAuthAdmin, ctrlUser.list);
