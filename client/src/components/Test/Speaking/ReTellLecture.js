...
const Component = ({ testId, question, onPause, onNextQ }) => {
  ...
  const handleOnStopPrepareCount2 = useCallback(async () => {
  ...
  const { count: prepareCount2, start: startPrepare2 } = useCountDownTime(question.prepareTimeout2, 0, handleOnStopPrepareCount2);
        ...
        <Container maxWidth="md">
          ...
          <Box display="flex" flexDirection="column" alignItems="center">
            ...
            <Box style={{ border: '1.5px solid #ccc', width: 320, maxWidth: '100%', background: '#eaf1fb' }} p={3} py={4} m={2}>
              ...
              <Typography>Current Status:</Typography>
              <Typography>
                {status === 'prepare' && `Recording in ${prepareCount2} seconds`}
